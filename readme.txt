...
A document on how to build a basic towed hydrophone: https://swfsc.noaa.gov/uploadedFiles/Divisions/PRD/Programs/Coastal_Marine_Mammal/Barlow%20et%20al%202008%20HydrophoneConstruction_TM-417.pdf
...
Preamplifier for 8 microphones, it will need a buffer circuit powered by VCC, the bias circuit ( R1,C2, R5 on the preamp circuit )will need to be deleted as it is for electret microphone. The piezoelectric elements negative side needs to be directly grounded. Schematic:
...
It cannot do distance calculations, but it should be possible to implement that in the software if arrays with enough distance between them are used and sensors as described below is fitted.
